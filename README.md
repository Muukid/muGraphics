...
A "squircle" in mug is a filled-in [squircle](https://en.wikipedia.org/wiki/Squircle), defined by a center point, a radius, and an exponent. Its respective struct is `mugSquircle` and has the following members:
